...
export function RoleCard({ role, title, description, icon: Icon, accent, onSelect }: RoleCardProps) {
    ...
    return (
        <m.button
            ...
            className={`group min-h-24 p-4 sm:p-5 md:p-7 lg:p-9 text-left flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-0 relative overflow-hidden transition-shadow duration-500
        ...
        >
            ...
            <div className="flex flex-col flex-1 relative z-10 w-full">
                <h2 className="mb-1 flex w-full items-center justify-between text-base font-bold tracking-tight text-slate-800 transition-colors dark:text-white sm:text-lg md:mb-3 md:text-2xl">
                    {title}
